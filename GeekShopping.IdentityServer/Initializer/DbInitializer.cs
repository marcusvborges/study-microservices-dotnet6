...
namespace GeekShopping.IdentityServer.Initializer
{
	public class DbInitializer : IDbInitializer
	{
		...
		public void Initializer()
		{
			...
			_user.CreateAsync(admin, "Marcola123$").GetAwaiter().GetResult();
			...
			{
				UserName = "marcola-client",
				Email = "marcola-client@gmail.com.br",
				EmailConfirmed = true,
				PhoneNumber = "+55 (81) 91234-5678",
				FirstName = "Marcola",
				LastName = "Client"
			...
			_user.CreateAsync(client, "Marcola123$").GetAwaiter().GetResult();
