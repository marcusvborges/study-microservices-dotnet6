...
{
    public partial class AddCartDatableOnDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cat_detail", x => x.id);
                    table.ForeignKey(
                        name: "FK_cat_detail_cart_header_CartHeaderId",
                        column: x => x.CartHeaderId,
                        principalTable: "cart_header",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_cat_detail_product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cat_detail_CartHeaderId",
                table: "cat_detail",
                column: "CartHeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_cat_detail_ProductId",
                table: "cat_detail",
                column: "ProductId");
        }
